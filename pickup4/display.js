...
var algoRound = 16191;
var roundMinutes = 85;
var codingStart =    new Date(2014, 10, 16,   19, 30, 0, 0);
var codingEnd =      new Date(2014, 10, 16,   20, 55, 0, 0);
var challengeStart = new Date(2014, 10, 16,   21, 00, 0, 0);
var challengeEnd =   new Date(2014, 10, 16,   21, 10, 0, 0);
var components = [44805, 44735, 44736];
var problemPoints = [250, 450, 1000];
...
var marathonRound = 16838;
var marathonStart = new Date(2016, 10, 19,  9, 0, 0, 0);
var marathonEnd =   new Date(2016, 10, 19, 19, 0, 0, 0);
...
// Algo Semi 1
var algoRound = 16839;
var codingStart =    new Date(2016, 10, 19,   20,  0, 0, 0);
var codingEnd =      new Date(2016, 10, 19,   21, 25, 0, 0);
var challengeStart = new Date(2016, 10, 19,   21, 30, 0, 0);
var challengeEnd =   new Date(2016, 10, 19,   21, 40, 0, 0);
var components = [-1, -1, -1];
var problemPoints = [250, 500, 1000];

// Algo Semi 2
var algoRound = 16841;
var codingStart =    new Date(2016, 10, 20,   18,  0, 0, 0);
var codingEnd =      new Date(2016, 10, 20,   19, 25, 0, 0);
var challengeStart = new Date(2016, 10, 20,   19, 30, 0, 0);
var challengeEnd =   new Date(2016, 10, 20,   19, 40, 0, 0);
var components = [-1, -1, -1];
var problemPoints = [250, 500, 1000];
...
// Algo Final
var algoRound = 16842;
var codingStart =    new Date(2016, 10, 21,   13, 30, 0, 0);
var codingEnd =      new Date(2016, 10, 21,   14, 55, 0, 0);
var challengeStart = new Date(2016, 10, 21,   15,  0, 0, 0);
var challengeEnd =   new Date(2016, 10, 21,   15, 10, 0, 0);
var components = [-1, -1, -1];
var problemPoints = [250, 500, 1000];
*/
