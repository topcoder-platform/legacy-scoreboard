...
var algoPointValues = [300, 400, 1000];
...
var resultA = [
["xudyh",  269.23,  310.09, "", 579.32,  269.23,  310.09, "",   579.32],
["rng_58",  190.08,  237.71, "", 427.79,  190.08,  237.71, "",   427.79],
["scott_wu",  233.04, "", "", 283.04,  233.04, "", "",   283.04],
["bcip", "",  281.77, "", 256.77, "",  281.77, "",   256.77],
["tourist", "Chal", "", "", 0.00, "Chal", "", "",     0.00],
["ikatanic", "", "", "", 0.00, "", "", "",     0.00],
];
...
function createRows(type) {
  ...
  setText("t-1", 'Points');
  if (type == 'a') {
    setText("p1c-1", algoPointValues[0]);
    setText("p2c-1", algoPointValues[1]);
    setText("p3c-1", algoPointValues[2]);
  }
  if (type == 'd') {
    setText("p1c-1", "#1");
    setText("p2c-1", "#2");
